...
import org.apache.iceberg.shaded.org.apache.avro.Schema.Field;
...
// Copied because the class avro relevant should be shaded
public class TestHelpers {
  ...
  public static void asMetadataRecord(Record file, FileContent content) {
    file.put(0, content.id());
    file.put(3, 0); // specId
  }

  public static void asMetadataRecord(Record file) {
